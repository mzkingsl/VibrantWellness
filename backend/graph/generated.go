...
type ComplexityRoot struct {
	Query struct {
		States func(childComplexity int, filter string) int
	}
...
type QueryResolver interface {
	States(ctx context.Context, filter string) ([]*model.State, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.states":
		...
		args, err := ec.field_Query_states_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.States(childComplexity, args["filter"].(string)), true
...
func (ec *executionContext) field_Query_states_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_states_argsFilter(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["filter"] = arg0
...
func (ec *executionContext) field_Query_states_argsFilter(
	ctx context.Context,
	rawArgs map[string]any,
) (string, error) {
...
func (ec *executionContext) _Query_states(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return ec.resolvers.Query().States(rctx, fc.Args["filter"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNState2ᚕᚖexampleᚗcomᚋstatesᚑtypeaheadᚋgraphᚋmodelᚐStateᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNState2ᚕᚖexampleᚗcomᚋstatesᚑtypeaheadᚋgraphᚋmodelᚐStateᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.State) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNState2ᚖexampleᚗcomᚋstatesᚑtypeaheadᚋgraphᚋmodelᚐState(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNState2ᚖexampleᚗcomᚋstatesᚑtypeaheadᚋgraphᚋmodelᚐState(ctx context.Context, sel ast.SelectionSet, v *model.State) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
